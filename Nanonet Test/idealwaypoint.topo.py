...
class idealwaypoint(Topo):
    def build(self):
        ...
        self.add_link_name("11", "0", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("12", "0", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("13", "0", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("14", "0", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("0", "11", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("0", "12", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("0", "13", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("0", "14", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("4", "5", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("5", "4", cost=4000, delay=0.2, bw=10000, directed=True)
        ...
        self.add_link_name("2", "5", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("5", "2", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("3", "5", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("5", "3", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("11", "5", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("12", "5", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("13", "5", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("14", "5", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("5", "11", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("5", "12", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("5", "13", cost=4000, delay=0.2, bw=10000, directed=True)
        self.add_link_name("5", "14", cost=4000, delay=0.2, bw=10000, directed=True)
    ...
    def dijkstra_computed(self):
        ...
        nhlist = self.get_dijkstra_route_by_name("11","5")
        for nh in nhlist:
            build_str += f" nexthop via {nh.nh} "+" encap seg6 mode inline segs {5} "+ f" weight {int(20/len(nhlist))} "
        self.add_command("11", f"ip -6 route add {{4}} metric 1 table 1 src {{11}}  {build_str}")
        # Demand from 12 to 4
        build_str = ""
        nhlist = self.get_dijkstra_route_by_name("12","1")
        for nh in nhlist:
            build_str += f" nexthop via {nh.nh} "+" encap seg6 mode inline segs {1} "+ f" weight {int(80/len(nhlist))} "
        nhlist = self.get_dijkstra_route_by_name("12","5")
        for nh in nhlist:
            build_str += f" nexthop via {nh.nh} "+" encap seg6 mode inline segs {5} "+ f" weight {int(20/len(nhlist))} "
        ...
        for nh in nhlist:
            build_str += f" nexthop via {nh.nh} "+" encap seg6 mode inline segs {2} "+ f" weight {int(80/len(nhlist))} "
        nhlist = self.get_dijkstra_route_by_name("13","5")
        for nh in nhlist:
            build_str += f" nexthop via {nh.nh} "+" encap seg6 mode inline segs {5} "+ f" weight {int(20/len(nhlist))} "
        ...
        for nh in nhlist:
            build_str += f" nexthop via {nh.nh} "+" encap seg6 mode inline segs {3} "+ f" weight {int(80/len(nhlist))} "
        nhlist = self.get_dijkstra_route_by_name("14","5")
        for nh in nhlist:
            build_str += f" nexthop via {nh.nh} "+" encap seg6 mode inline segs {5} "+ f" weight {int(20/len(nhlist))} "
...
topos = {'idealwaypoint': (lambda: idealwaypoint())}
