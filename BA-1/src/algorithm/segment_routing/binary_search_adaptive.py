...
class BinarySearchAdaptiveRouting:
    BIG_M = 10 ** 9
        ...
        for s in range(self.__n):
            ...
            for t in range(self.__n):
                ...
                for u_idx in range(self.__n - 1):
                    ...
                    successors = list(v for v in self.__g.iterNeighbors(u) if self.__weights[(u, v)] == distances[u][t] - distances[v][t])
    ...
    def get_name(self):
        return f"binary_search_adaptive"
