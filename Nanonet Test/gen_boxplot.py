...
def box_plot_all_top(df_plot, x_label="Model\n", y_label="\nMax. Normalized Link Utilization", size=(30, 6), title=None, y_lim_top=None):
	...
	plt.yticks([0, 1], ['Joint', 'idealwaypoint'])
...
data_idealwaypoint = read_csv_data( CSV_FILENAME, "idealwaypoint.topo.sh")

data_all = [data_joint, data_idealwaypoint]
...
print("idealwaypoint Median: ", statistics.median(data_idealwaypoint))
print("idealwaypoint Minimum: ", min(data_idealwaypoint))
print("idealwaypoint Maximum: ", max(data_idealwaypoint))
